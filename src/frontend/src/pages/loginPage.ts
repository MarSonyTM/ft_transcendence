        ...
        <div class="neon-grid">
            ...
            <div class="glass-card" style="max-width: 450px; width: 100%;">
                ...
                <div style="text-align: center; margin-bottom: 2em;">
                    ...
                    <p style="color: #9ca3af; font-size: 1rem;">Sign in to your account</p>
                </div>
                ...
                <div class="glass-card" style="padding: 2em; margin-bottom: 1.5em;">
                    <form id="loginForm" style="display: flex; flex-direction: column; gap: 1.5em;">
                        ...
                        <button
                            ...
                            style="width: 100%; font-size: 1.1em; padding: 0.8em; margin-bottom: 1em;"
                        >
                            🚀 Login
                        </button>
                        ...
                        <button id="googleSignInBtn" type="button" class="btn btn-neon accent" style="display: flex; align-items: center; justify-content: center; gap: 0.5em; padding: 0.75em; font-size: 1em; min-width: 100%; margin-bottom: 1em;">
                        ...
                        <div id="loginError" style="text-align: center; font-size: 0.9em; min-height: 1.2em;"></div>
                    </form>
                </div>
                ...
                <div style="text-align: center; margin-bottom: 1.5em;">
                    <p style="color: #9ca3af; font-size: 0.9em; margin-bottom: 0.5em;">
                        ...
                        <button id="toRegisterBtn" class="btn btn-neon accent" style="padding: 0.2em 0.5em; font-size: 0.9em;">Create one</button>
                    </p>
                </div>
